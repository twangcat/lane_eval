...
def main(args=None):
    ...
    proto_fname = '/deep/group/driving_data/twangcat/caffe_results/proto/raw_outputs/'+unique_name+'-Vshape_batch0.proto'
    ...
    for it in range(num_batches):
      ...
      proto_fname = '/deep/group/driving_data/twangcat/caffe_results/proto/raw_outputs/'+unique_name+'-Vshape_batch'+str(it)+'.proto'
      fid = open(proto_fname,'r')
      bpv.ParseFromString(fid.read())
      fid.close()
